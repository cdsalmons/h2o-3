...
def offset_poisson():
    ...
    assert abs(1.077275 - predictions.min()) < 0.006, "expected prediction min to be {0}, but got {1}". \
        format(1.077275, predictions.min())
    assert abs(398.0608 - predictions.max()) < 0.2, "expected prediction max to be {0}, but got {1}". \
